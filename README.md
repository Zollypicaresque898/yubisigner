...
yubisigner is a compact GUI program for signing and verifying  
files with a YubiKey. It supports international cryptographic  
...
* CMT (Create Merkle Tree) and VMT (Verify Merkle Tree) for  
source code repository, which writes a merkle-tree.txt file  
and the displayed identicon can be computed too with my  
[identicons](https://github.com/Ch1ffr3punk/identicons) program.
